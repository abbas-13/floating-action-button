...
export const SuggestionForm = () => {
  ...
  return (
    ...
    >
      <label className="w-9/12 text-center text-neutral-600 text-xl md:text-lg font-semibold font-['Poppins']">
      ...
      <div className="w-full">
        ...
        <select
          className="my-2 mb-4 text-neutral-600 text-xl md:text-xs font-['Poppins'] bg-gray-200 rounded-lg w-full p-2"
          id="issues"
          name="issue-select"
